...
echo "# modified" >> "$TARGET/.claude/commands/quick.md"
...
if ! grep -q "^# modified$" "$TARGET/.claude/commands/quick.md" 2>/dev/null; then
...
if [[ -f "$UPGRADE_TARGET/.claude/commands/quick.md" ]]; then
